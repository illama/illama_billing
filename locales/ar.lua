local translations = {
    ...
    ['installment_payment'] = 'دفعة بالتقسيط',
    ['installment_payment_desc'] = 'تم دفع هذا القسط بقيمة $%s.',
    ['installment_invalid'] = 'خطة الدفع غير صالحة أو مكتملة بالفعل.',
    ...
    ['success'] = "نجاح",
    ['payment_received_recurring'] = "تم استلام دفعة ربوية",
