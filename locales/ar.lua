Locales['ar'] = {
    ...
    ['recurring_bills_desc'] = 'إدارة اشتراكاتك والمدفوعات المتكررة',
    ...
    ['group_bill_split_equally'] = 'تقسيم متساوي',
    ...
    ['amounts_not_total'] = 'يجب أن يساوي مجموع المبالغ المبلغ الإجمالي',
    ...
    ['standard_bill_desc'] = 'إنشاء فاتورة لمرة واحدة',
    ['select_template'] = 'اختر قالباً أو أنشئ فاتورة مخصصة',
    ['custom_bill'] = 'فاتورة مخصصة',
    ['society_payment'] = 'دفع للشركة',
    ...
    ['select_subscription_template'] = 'اختر قالباً أو أنشئ اشتراكاً مخصصاً',
    ['interval_days'] = 'الفترة (بالأيام)',
    ['interval_days_desc'] = 'عدد الأيام بين كل دفعة',
    ['recurring_reason_desc'] = 'أدخل سبب الفواتير المتكررة',
    ['confirm_recurring_bill'] = 'فاتورة متكررة بقيمة $%s كل %d يوم لـ: %s',
    ...
    ['payment_count_desc'] = 'اختر عدد الدفعات المقدمة',
    ...
    ['no_bills_desc'] = 'لم يتم إنشاء أي فواتير بعد',
    ...
    ['select_players'] = 'اختر لاعبين',
    ['select_min_players'] = 'اختر لاعبَين على الأقل',
    ...
    ['recurring_setup_success'] = 'تم إعداد الفواتير المتكررة',
    ...
    -- الأخطاء
    ['error'] = 'خطأ',
    ['insufficient_rights'] = 'لا تملك الصلاحيات الكافية',
    ['cannot_load_data'] = 'تعذر تحميل بياناتك',
    ['no_nearby_players'] = 'لا يوجد لاعبون قريبون',
    ['need_multiple_players'] = 'يجب وجود لاعبَين على الأقل بالقرب لإنشاء فاتورة جماعية',
    ['invalid_amount'] = 'يجب أن يكون المبلغ أكبر من 0',
    ['invalid_interval'] = 'فترة غير صالحة (1-365 يوم)',
    ['insufficient_funds'] = 'لا تملك مالاً كافياً (ينقص $%s)',
    ...
    ['recurring_cancelled'] = 'تم إلغاء الفاتورة المتكررة بسبب عدم النشاط',
    ['recurring_cancelled_inactivity'] = 'تم إلغاء الاشتراك بسبب عدم النشاط',
    ['player_disconnected_recurring'] = 'انقطع اتصال اللاعب، تم إلغاء الفاتورة المتكررة',
    ...
    ['script_up_to_date'] = '^2[illama_billing] النص البرمجي محدث (v%s)^7',
    ...
    ['check_bills'] = 'تحقق من الفواتير',
    ['check_bills_desc'] = 'تحقق من الفواتير الحالية',
